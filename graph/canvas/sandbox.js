...
function Quadratic() {
    ...
    ctx.bezierCurveTo(20 + offset, 25, 20 + offset, 55, 20 + offset, 62.5);
    ...
    ctx.beginPath();
    ctx.fillStyle = 'red';
    ctx.arc(75 + offset, 37, 3, 0, Math.PI * 2, true);
    ctx.arc(70 + offset, 25, 3, 0, Math.PI * 2, true);
    ctx.arc(50 + offset, 25, 3, 0, Math.PI * 2, true);

    ctx.arc(20 + offset, 25, 3, 0, Math.PI * 2, true);

    ctx.arc(20 + offset, 55, 3, 0, Math.PI * 2, true);
    ctx.arc(20 + offset, 62.5, 3, 0, Math.PI * 2, true);

    ctx.arc(20 + offset, 80, 3, 0, Math.PI * 2, true);
    ctx.arc(40 + offset, 102, 3, 0, Math.PI * 2, true);
    ctx.arc(75 + offset, 120, 3, 0, Math.PI * 2, true);
